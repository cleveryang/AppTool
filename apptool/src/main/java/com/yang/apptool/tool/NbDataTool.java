...
public class NbDataTool {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link NbConstTool.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link NbConstTool.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link NbConstTool.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link NbConstTool.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, NbConstTool.MemoryUnit unit) {
        if (byteNum < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
                return (double) byteNum / NbConstTool.BYTE;
            case KB:
                return (double) byteNum / NbConstTool.KB;
            case MB:
                return (double) byteNum / NbConstTool.MB;
            case GB:
                return (double) byteNum / NbConstTool.GB;
        }
    }
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, NbConstTool.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
                return size * NbConstTool.BYTE;
            case KB:
                return size * NbConstTool.KB;
            case MB:
                return size * NbConstTool.MB;
            case GB:
                return size * NbConstTool.GB;
        }
    }
    ...
    public static String byte2FitSize(long byteNum) {
        ...
        } else if (byteNum < NbConstTool.KB) {
            return String.format(Locale.getDefault(), "%.3fB", (double) byteNum);
        } else if (byteNum < NbConstTool.MB) {
            return String.format(Locale.getDefault(), "%.3fKB", (double) byteNum / NbConstTool.KB);
        } else if (byteNum < NbConstTool.GB) {
            return String.format(Locale.getDefault(), "%.3fMB", (double) byteNum / NbConstTool.MB);
        } else {
            return String.format(Locale.getDefault(), "%.3fGB", (double) byteNum / NbConstTool.GB);
        }
    }
    ...
    public static ByteArrayOutputStream input2OutputStream(InputStream is) {
        ...
        try {
            ...
            byte[] b = new byte[NbConstTool.KB];
            int len;
            while ((len = is.read(b, 0, NbConstTool.KB)) != -1) {
                os.write(b, 0, len);
            }
            return os;
        } catch (IOException e) {
