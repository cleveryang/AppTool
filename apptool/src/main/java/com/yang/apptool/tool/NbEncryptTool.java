...
public class NbEncryptTool {
    ...
    public static String encryptMD2ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptMD2(data));
    }
    ...
    public static String encryptMD5ToString(String data, String salt) {
        return NbDataTool.bytes2HexString(encryptMD5((data + salt).getBytes()));
    }
    ...
    public static String encryptMD5ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptMD5(data));
    }
    ...
    public static String encryptMD5ToString(byte[] data, byte[] salt) {
        ...
        return NbDataTool.bytes2HexString(encryptMD5(dataSalt));
    }
    ...
    public static String encryptMD5File2String(File file) {
        return encryptMD5File(file) != null ? NbDataTool.bytes2HexString(encryptMD5File(file)) : "";
    }
    ...
    public static String encryptSHA1ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptSHA1(data));
    }
    ...
    public static String encryptSHA224ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptSHA224(data));
    }
    ...
    public static String encryptSHA256ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptSHA256(data));
    }
    ...
    public static String encryptSHA384ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptSHA384(data));
    }
    ...
    public static String encryptSHA512ToString(byte[] data) {
        return NbDataTool.bytes2HexString(encryptSHA512(data));
    }
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return NbEncodeTool.base64Encode(encryptDES(data, key));
    }
    ...
    public static String encryptDES2HexString(byte[] data, byte[] key) {
        return NbDataTool.bytes2HexString(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(NbEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] decryptHexStringDES(String data, byte[] key) {
        return decryptDES(NbDataTool.hexString2Bytes(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return NbEncodeTool.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static String encrypt3DES2HexString(byte[] data, byte[] key) {
        return NbDataTool.bytes2HexString(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(NbEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] decryptHexString3DES(String data, byte[] key) {
        return decrypt3DES(NbDataTool.hexString2Bytes(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return NbEncodeTool.base64Encode(encryptAES(data, key));
    }
    ...
    public static String encryptAES2HexString(byte[] data, byte[] key) {
        return NbDataTool.bytes2HexString(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(NbEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] decryptHexStringAES(String data, byte[] key) {
        return decryptAES(NbDataTool.hexString2Bytes(data), key);
    }
